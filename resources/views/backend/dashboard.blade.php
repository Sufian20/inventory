...
@php
    use App\Models\Order;
      ...
      $year = date('Y');
        ...
        $torders = Order::where('order_date', $date)->sum('id');
        $monthly = Order::where('month', $month)->sum('total');
        $yearly = Order::where('year', $year)->sum('total')
@endphp
<div class="row">
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="mini-stat-info text-right text-muted">
                <span class="counter">{{ $sum }}</span>
                Total Sales
            </div>
            <div class="tiles-progress">
                <div class="m-t-20">
                    <h5 class="text-uppercase">Today <span class="pull-right"></span></h5>
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="mini-stat-info text-right text-muted">
                <span class="counter">{{$torders}}</span>
                New Orders
            </div>
            <div class="tiles-progress">
                <div class="m-t-20">
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="tiles-progress">
                <div class="m-t-20">
                    <h5 class="text-uppercase"> Monthly Sales <span class="pull-right"></span></h5>
                    <div class="progress progress-sm m-0">
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="mini-stat-info text-right text-muted">
                <span class="counter">{{$yearly}}</span>
                Yearly Sales
            </div>
            <div class="tiles-progress">
                <div class="m-t-20">
                    <h5 class="text-uppercase">Yearly Sales <span class="pull-right"></span></h5>
                    <div class="progress progress-sm m-0">
                ...
                <div class="inbox-widget nicescroll mx-box">
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="backend/images//users/avatar-1.jpg" class="img-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="backend/images//users/avatar-8.jpg" class="img-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="backend/images//users/avatar-9.jpg" class="img-circle" alt=""></div>
                    ...
                    <ul class="conversation-list nicescroll">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="backend/images//avatar-1.jpg" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="backend/images//users/avatar-5.jpg" alt="Female">
                                <i>10:01</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="backend/images//users/avatar-5.jpg" alt="male">
                                <i>10:02</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
