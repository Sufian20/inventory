    ...
    <div class="col-md-8">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Add Expenses <span>
                        <a href="{{route('MonthlyExpenses')}}" class=" btn btn-sm btn-danger pull-right">This Month</a>
            ...
            <div class="panel-body">
                ...
                <form role="form" action="{{route('PostExpenses')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="amount" row="4" class="form-control" @error('amount') is-invalid @enderror" value="{{ old('amount') }}" name="amount" id="amount" placeholder="Enter Amount">
                        @error('amount')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
